insert into Status (Orden,Descripcion) values (1,'EN ESPERA');
insert into Status (Orden,Descripcion) values (2,'LLAMANDO');
insert into Status (Orden,Descripcion) values (3,'EN PROCESO');
